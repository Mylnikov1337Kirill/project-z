# Project Z AI session closeout

Этот чеклист обязателен в конце каждой AI-assisted сессии по Project Z. Его задача -- не плодить документы, а держать рабочий контекст свежим для следующего агента.
